...
# # root.configure(background="#6CDEB8")
# # root.mainloop()
# # s1= Entry(root)
# # s1.pack()
# # root.mainloop()
...
def confirm_log():
    email = input("Enter your mail").get()
...
login_btn = Button(root,text="Login",font=('Arial', 18,'bold'),bg='#00704A',fg='white',command=confirm_log)
